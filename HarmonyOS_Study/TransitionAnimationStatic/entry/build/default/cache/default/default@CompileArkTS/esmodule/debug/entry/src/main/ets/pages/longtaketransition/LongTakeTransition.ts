        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                ...
                }, Column);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            let componentCall = new TitleBar(this, { title: { "id": 16777231, "type": 10003, params: [], "bundleName": "com.huawei.transitionanimation", "moduleName": "entry" } }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/longtaketransition/LongTakeTransition.ets", line: 70, col: 11 });
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                if (isInitialRender) {
                                    let componentCall = new CardView(this, {
                                        card
                                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/longtaketransition/LongTakeTransition.ets", line: 74, col: 17 });
                                    ViewPU.create(componentCall);
                                    let paramsLambda = () => {
                                        return {
                                            card
